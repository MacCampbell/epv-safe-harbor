...
ggplot(dotplot, aes(x=LogTransformed, fill=Type)) + 
  ...
  scale_fill_manual(values = c("darkblue","darkgreen"), labels=c(paste0("Intergenic (n=",nrow(inter),")"),
...
ggsave("outputs/figures/figure-1b.pdf")
``` 
